...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2025 a las 04:42:53
...
INSERT INTO `almacen` (`id`, `marca`, `modelo`, `año_fabricacion`, `precio`, `color`, `estado`, `categoria`, `imagen`, `descripcion`) VALUES
...
INSERT INTO `clientes` (`id`, `Apellido_Paterno`, `Apellido_Materno`, `nombre`, `telefono`, `Correo`, `calle`, `colonia`, `municipio`, `ciudad`, `estado`, `cp`, `curp`, `licencia`, `genero`, `edad`) VALUES
(1, 'Salinas', 'Mata', 'Luis Antonio', 562590955, 'luis.salinas.contacto@gmail.com', 'av. Coapa', 'Santa Barabara', 'Cuautitlan Izcalli ', 'Mexico', '', '0', '', '', '', ''),
(0, 'Marin', 'Sanchez', 'Jose Abraham', 55718333, 'elmarinxd@gmail.com', 'Santo Tomas ', 'Corpus Christy', 'AO', 'CDMX', '', '01530', 'MASA000720HDFRNBA1', '374854', 'Masculino', '25'),
(0, 'Mateo', 'Dorantes', 'Andres', 6647547, 'Andres.com', 'La roma', 'Romas', 'Cuautemoc', 'CDMX', '', '', '', '', '', '0'),
(0, 'Perez ', 'ALvarado', 'Adan', 55768692, 'adanpr@cua.uam', 'Av tamaulipas 98', 'westhill', 'Cuajimalpa', 'CDMX', 'CDMX', '01660', 'ADPX756GHGYU66', '64734857', 'Masculino', '22'),
(0, 'Nuno', 'Diaz', 'Aldo', 8965998, 'aldoconti.com', 'Santa Fe', 'Calendaria', 'AO', 'CDMX', 'CDMX', '', '', '', '', '0'),
(0, 'Doblas', 'Ksjuber', 'Ruben', 7686875, 'rubius.com', 'Andoni 767', 'Salmuera', 'Andorra', 'A La Bella', 'europe', '79681', '', '', '', '0');
