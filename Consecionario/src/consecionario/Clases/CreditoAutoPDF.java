...
try{
        double monto        = carro.getPrecio() - credito.getEnganche();
        double enganche     =  credito.getEnganche(); 
        double plazoMeses   =  credito.getMeses();  
        double tasaAnual    =  credito.getTasa_interes();   
        double pagoMensual  =  credito.getPago_mensual(); 
